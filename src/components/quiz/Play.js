...
class Play extends Component{
   ...
   playButtonSound=()=>{
    ...
    render(){
        const {currentQuestion, currentQuestionIndex,fiftyFifty,numberOfQuestion,hints,time}     = this.state;
        return(
            <Fragment>
                ...
                <div className ="questions">
                    ...
                    <div className="lifeline-container">
                        <p>
                            <span onClick={this.handdleFiftyFifty} className="mdi mdi-set-center mdi-24px lifeline-icon">
                    ...
                    <div className="options-container">
                        <p onClick={this.handdleOptionClick} className="option">{currentQuestion.optionA}</p>
                        <p onClick={this.handdleOptionClick} className="option">{currentQuestion.optionB}</p>
                    </div>
                    <div className="options-container">
                        <p onClick={this.handdleOptionClick} className="option">{currentQuestion.optionC}</p>
                        <p onClick={this.handdleOptionClick} className="option">{currentQuestion.optionD}</p>
                    </div>
