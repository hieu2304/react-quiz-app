...
class PlayUI3 extends Component{
    constructor (props){
         super(props);
        ...
        return(
            <Fragment>
                ...
                <div className ="questions">
                    ...
                    <h5>{currentQuestion.question}</h5><br/>
                    <div >
                        <ol className="rank">
                        {
                            //className="right"
                            // file css cua cai nay dau
                           this.state.questions.map((item,index)=>(
                                <li key={index} className="flex j-between a-center">
                                    { item.answer}
                                    <div className="flex a-center">
                                        <span className="check"><span onClick={this.handdleOptionClick3} className="mdi mdi-checkbox-marked-circle mdi-24px lifeline3-icon"></span></span>
                                        <span className="check"><span onClick={this.handdleOptionClick3} className="mdi mdi-close-circle mdi-24px lifeline3-icon"></span></span>
                                    </div>
                                </li>                               
                           ))
                        }                                        
